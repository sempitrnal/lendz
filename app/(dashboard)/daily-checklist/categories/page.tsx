      ...
      <div className="mb-4 flex items-center gap-3">
        <Link
          ...
          className="inline-flex items-center gap-1 rounded-md border-2
            border-slate-900 bg-white px-2 py-1 text-xs font-bold uppercase
            text-slate-600 shadow-[2px_2px_0px_0px_#0f172a] transition
            hover:-translate-y-0.5 hover:translate-x-0.5 dark:border-border
        ...
        <h1
          className="text-2xl font-black lowercase text-slate-600
