...
export default function NeobrutButton({
  ...
  return (
    <button
      className={neobrutButtonClassName(variant, className)}
      {...props}
    />
  );
}
