    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          -translate-y-1/2 gap-4 rounded-2xl border border-slate-200 bg-popover
          p-6 text-sm text-popover-foreground outline-none sm:max-w-md
          sm:max-h-[85svh] dark:border-slate-700 data-open:animate-in
