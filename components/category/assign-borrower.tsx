            ...
            <DialogContent className="sm:max-w-lg">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                    {selected.map((id) => {
                        ...
                        return (
                            <div
                                key={id}
                                className="flex items-center gap-2 rounded bg-black px-2 py-1 text-white text-xs"
                            >
                ...
                <Command>
                    ...
                    <CommandList className="mt-5">
                        ...
                        {borrowers.filter((b) => !selected.includes(b.id)).map((b) => (
                            <CommandItem
                                key={b.id}
                                onSelect={() => {
                                    setSelected((prev) =>
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2 text-xs">
                    ...
                    <div className="rounded-full border border-blue-200 bg-blue-50 px-2 py-1 font-medium text-blue-700">
                        Available To Assign: {borrowers.filter((b) => !selected.includes(b.id)).length}
                    </div>
                </div>
                {/* ACTION BUTTONS */}
