...
export default function MobileTopBar() {
  ...
  if (pathname.startsWith("/accounts/") && pathname.endsWith("/view"))
    return null;
  ...
  return (
    <div className="dark:border-border/50 dark:bg-background/90 fixed top-0 right-0 left-0 z-40 flex h-10 items-center gap-2 border-b border-slate-200 bg-white/90 px-3 backdrop-blur sm:hidden print:hidden">
      <button
        type="button"
        onClick={handleBack}
        aria-label="Go back"
